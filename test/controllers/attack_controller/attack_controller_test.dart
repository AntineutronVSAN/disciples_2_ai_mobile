...
void main() {
  ...
  test('ATTACK CONTROLLER TRANSFORM OTHER TEST', () async {
    ...
    var attackResponse = await attackController.applyAttack(
        ...
        onAddUnit2Queue: (u) {},
        rollConfig: rollConfig);
    expect(attackResponse.success, true, reason: 'Юнит может повысить урон. Сообщение - ${responseAction.message}');
    ...
    expect(units[7].attacksMap[AttackClass.L_BOOST_DAMAGE] != null, true, reason: 'Повышение урона должно висеть на юните');
    ...
    attackResponse = await attackController.applyAttack(
        ...
        onAddUnit2Queue: (u) {},
        rollConfig: rollConfig);
    expect(attackResponse.success, false, reason: 'Юнит не может повысить урон. Сообщение - ${responseAction.message}');
    ...
    attackResponse = await attackController.applyAttack(
        ...
        onAddUnit2Queue: (u) {},
        rollConfig: rollConfig);
    expect(attackResponse.success, true, reason: 'Сообщение - ${responseAction.message}');

    //expect(units[7].unitAttack.damage, units[7].unitAttack.firstDamage + (units[7].unitAttack.firstDamage * 0.75).toInt(), reason: 'Неврно высчитано повышение урона');
    expect(units[7].attacksMap[AttackClass.L_BOOST_DAMAGE] != null, true, reason: 'Повышение урона должно висеть на юните');
    expect(units[7].attacksMap[AttackClass.L_LOWER_DAMAGE] != null, true, reason: 'Понижение урона должно висеть на юните');
    expect(units[7].attacksMap[AttackClass.L_LOWER_INITIATIVE] != null, true, reason: 'Понижение ини должно висеть на юните');

    expect(units[7].unitAttack.initiative, units[7].unitAttack.firstInitiative ~/ 2, reason: 'Ini');

    expect(units[7].unitAttack.damage, units[7].unitAttack.firstDamage
        + (units[7].unitAttack.firstDamage * 0.75).toInt()
        - (units[7].unitAttack.firstDamage * 0.5).toInt() , reason: 'Неврно высчитано повышение урона');
    ...
    expect(units[7].attacksMap[AttackClass.L_BOOST_DAMAGE] != null, true, reason: 'должно висеть на юните');
    expect(units[7].attacksMap[AttackClass.L_LOWER_DAMAGE] != null, true, reason: 'должно висеть на юните');
    expect(units[7].attacksMap[AttackClass.L_LOWER_INITIATIVE] != null, true, reason: 'должно висеть на юните');
    expect(units[7].attacksMap[AttackClass.L_TRANSFORM_OTHER] != null, true, reason: 'должно висеть на юните');

    expect(units[7].unitAttack.initiative, testUnitInit ~/ 2, reason: '');
    expect(units[7].unitAttack.damage, testUnitDamage
        + (testUnitDamage * 0.75).toInt()
        - (testUnitDamage * 0.5).toInt() , reason: 'Неврно высчитано повышение урона');
    ...
    expect(units[7].unitAttack.damage, 25
        + (25 * 0.75).toInt()
        - (25 * 0.5).toInt() , reason: 'Неврно высчитано повышение урона');
    ...
    expect(units[7].unitAttack.damage, 25, reason: 'Неврно высчитано повышение урона');
  ...
  test('ATTACK CONTROLLER immune once and damage', () async {
    ...
    var resp = await attackController.applyAttack(
        3,
        8,
        units,
        responseAction,
        onAddUnit2Queue: (u) {},
        rollConfig: rollConfig);
    expect(resp.success, false, reason: 'Сообщение - ${responseAction.message}');
    resp = await attackController.applyAttack(
        8,
        3,
        units,
        responseAction,
    ...
    expect(units[7].currentHp,
        testDamagerWithOnceImmuneSelfHp
            ...
            - DamageScatter.maxScatterValue*2, reason: '');
