  ...
  Future<ResponseAction> applyAttackToUnit(
    ...
    switch (attack.attackConstParams.attackClass) {
      ...
      case AttackClass.L_BOOST_DAMAGE:
        ...
        if (units[target].unitAttack.attackConstParams.firstDamage <= 0) {
          break;
        }
        ...
        final targetUnitHasThisAttack =
        targetUnit.attacksMap.containsKey(attack.attackConstParams.attackClass);
        final currentAttackDuration = attack.attackConstParams.infinite ? 100 : 1;
        ...
        if (!targetUnitHasThisAttack) {
          ...
          if (oldDebuffLevel > attackLevel) {
            ...
            final oldDebuffDuration =
                units[target].attacksMap[attack.attackConstParams.attackClass]!.currentDuration;
      ...
      case AttackClass.L_LOWER_INITIATIVE:
        ...
        final targetUnitIniFirst = units[target].unitAttack.attackConstParams.firstInitiative;
      ...
      case AttackClass.L_POISON:
        ...
        if (!targetUnitHasThisAttack) {
          ...
          final currentAttackDamage =
              units[target].attacksMap[attack.attackConstParams.attackClass]!.damage;
